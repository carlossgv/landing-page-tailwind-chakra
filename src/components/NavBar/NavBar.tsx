...
export default function NavBar({ onThemeClick, onLocaleClick, theme }: Props) {
  ...
  return (
    <nav className="w-full flex flex-col items-center md:flex-row md:justify-between bg-primaryBg dark:bg-primaryBgDark text-text dark:text-textDark">
      ...
      <div className="flex space-x-1">
        <button onClick={onLocaleClick} className="">
          {locale.toUpperCase()}
        </button>
